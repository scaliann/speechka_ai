...
if __name__ == '__main__':
    ...
    parser.add_argument('--dst_root', type=str, default='cleaned',
                        help='directory to put audio files split by delta_time')
    parser.add_argument('--delta_time', '-dt', type=float, default=1,
                        help='time in seconds to sample audio')
    parser.add_argument('--sr', type=int, default=44100,
                        help='rate to downsample audio')

    parser.add_argument('--fn', type=str, default='8230-9254_burr',
                        help='file to plot over time to check magnitude')
    parser.add_argument('--threshold', type=str, default=400,
